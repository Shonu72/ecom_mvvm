...
import 'package:ecom_mvvm/presentation/views/checkout/payments.dart';
import 'package:ecom_mvvm/presentation/views/checkout/widgets/address_tile.dart';
import 'package:ecom_mvvm/presentation/views/checkout/widgets/delivery_partner_widget.dart';
import 'package:ecom_mvvm/presentation/views/checkout/widgets/promo_code.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    double totalAmount = cartController.totalPrice + shippingCharges;
    return Scaffold(
        appBar: AppBar(
          title: const AppText(
            text: 'CheckOut',
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    //   );
                    // }));
                    PaymentHelper(context).openCheckout(totalAmount);
                  },
